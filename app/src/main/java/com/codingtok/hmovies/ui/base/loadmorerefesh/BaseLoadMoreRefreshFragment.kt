...
abstract class BaseLoadMoreRefreshFragment<ViewBinding: ViewDataBinding, ViewModel: BaseLoadMoreRefreshViewModel<T>, T: Any>: BaseRefreshFragment<ViewBinding, ViewModel, T>() {
